...
const Footer = () => {
    return (
        ...
        <aside>
           <img src="https://i.ibb.co.com/nsmcR5q/logo.png" alt="" />
             <br /> 
             <div>
         <p>There are many variations of passages of <br /> lorem Ipsum available, but the majority </p>
          <h3>Download for app</h3>
             </div>
             <div className="flex flex-col items-center justify-center flex-shrink-0 mt-6 space-y-4 sm:flex-row sm:space-y-0 sm:space-x-4 lg:ml-4 bg-black text-white lg:mt-0 lg:justify-end">
